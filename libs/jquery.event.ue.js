...
(function ( $ ) {
  ...
  fnMotionStart = function ( arg_map ) {
    ...
    motion_map = {
	  ...
	  px_center_x	: undefined,
	  px_center_y	: undefined
    };
  ...
  fnMotionMove  = function ( arg_map ) {
    ...
    if ( motion1ZoomId && motion2ZoomId
	  ...
	  px_center_x = (mzoom1_map.px_current_x + mzoom2_map.px_current_x)/2;
	  px_center_y = (mzoom1_map.px_current_y + mzoom2_map.px_current_y)/2;
    ...
    if ( do_zoommove ){
	  ...
	  motion_map.px_center_x = px_center_x;
	  motion_map.px_center_y = px_center_y;
      $.extend( event_ue, motion_map );
      $(motion_map.elem_bound).trigger(event_ue);
      return;
    }
